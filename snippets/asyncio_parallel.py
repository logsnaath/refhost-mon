...
#hosts = ["fryer.qam.suse.cz", "bojack.qam.suse.cz", "adam.qam.suse.de", "alice.qam.suse.de", "antares.qam.suse.de"]

async def check_ssh(host):
    ...
    return host, process.returncode

async def run_probe():
    tasks = [check_ssh(host) for host in hosts]
